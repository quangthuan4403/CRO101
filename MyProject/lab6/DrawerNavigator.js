...
function CustomDrawerContent(props) {
  return (
    <DrawerContentScrollView {...props}>
      {/* Hình nền */}
      <ImageBackground
        source={require('../assets/image.png')} // Thay thế bằng đường dẫn đến hình ảnh của bạn
      ...
      >
        ...
        <View style={styles.headerContainer}>
          <Image 
            ...
            style={styles.avatar}
          />
          <Text style={styles.headerName}>Phạm Qaung Thuận</Text>
          <Text style={styles.headerEmail}>Phamquangthuankcr1@gmail.com</Text>
        </View>
      </ImageBackground>
